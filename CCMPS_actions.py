...
def refresh_window (window, status):
    ...
    for element in ['-fractionation_reset-', '-fractionation_summary-', '-fractionation_export-']:
    ...
    if status['training']:
        ...
        for element in ['-statistic_export-', '-statistic_import-', '-statistic_report-',
        ...
        for element in ['-statistic_predict-',
                        '-statistic_export-', '-statistic_import-', '-statistic_report-',
                        '-statistic_reset-', '-statistic_heatmap-', '-statistic_distribution-',
